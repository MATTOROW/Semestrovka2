...
public record UpdateCategoryRequest(
        @Schema(description = "Новое название категории", example = "В работе", requiredMode = Schema.RequiredMode.REQUIRED)
        @NotBlank(message = "Название категории обязательно")
        @Size(min = 2, max = 30, message = "Название категории должно быть от 2 до 30 символов")
        String name,

        @Schema(description = "Новый цвет в HEX-формате", example = "#FF0000", requiredMode = Schema.RequiredMode.REQUIRED)
